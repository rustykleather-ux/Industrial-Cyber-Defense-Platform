  ...
  return (
    <div className="app">
      ...
      <div className="topology">
        ...
        <div
          className={`topology-node ${getNodeClass(getDevice("SCADA Server"))}`}
        >
          SCADA Server
        ...
        <div className="topology-branches">
          <div className="branch">
            <div className="topology-line"></div>
            <div
              className={`topology-node ${getNodeClass(getDevice("PLC-1"))}`}
            >
              PLC-1
          ...
          <div className="branch">
            <div className="topology-line"></div>
            <div
              className={`topology-node ${getNodeClass(getDevice("PLC-2"))}`}
            >
              PLC-2
          ...
          <div className="branch">
            ...
            <div
              className={`topology-node ${getNodeClass(
                getDevice("Solar Inverter")
              )}`}
            >
              Solar Inverter
              <span>
                {getDevice("Solar Inverter")?.ip_address || "Unknown IP"}
              </span>
            </div>
          </div>
        </div>
        ...
        <tbody>
          {(vulnerabilities || []).map((vuln) => (
            <tr key={vuln.id}>
              ...
              <td>
                <span
                  className={`badge ${(vuln.severity || "low").toLowerCase()}`}
                >
        ...
        {(alerts || []).length === 0 ? (
          ...
          (alerts || []).map((alert) => (
            ...
            >
              ...
              <span
                className={`badge ${(alert.severity || "low").toLowerCase()}`}
              >
